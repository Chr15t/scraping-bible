...
def start_scraper():
  ...
  excel_filename = 'english_library_data_link_download.csv'
  df_downloaded.to_csv(excel_filename)

  df_downloaded_error.to_csv('english_error_library_download_error.csv')
